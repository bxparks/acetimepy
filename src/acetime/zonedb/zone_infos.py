...
#     --input_dir /Users/brian/src/AceTimePython/src/acetime/zonedb/tzfiles
#     --output_dir /Users/brian/src/AceTimePython/src/acetime/zonedb
#     --tz_version 2022g
#     --action zonedb
#     --language python
#     --granularity 1
...
# Africa/Abidjan {STDOFF '-0:16:08' not on 15-minute boundary}
# Africa/Algiers {
#   STDOFF '0:09:21' not on 15-minute boundary,
#   Algeria {Added anchor rule at year 0}
# }
# Africa/Bissau {STDOFF '-1:02:20' not on 15-minute boundary}
# Africa/Cairo {
...
#   Sudan {Added anchor rule at year 0}
# }
# Africa/Lagos {STDOFF '0:13:35' not on 15-minute boundary}
# Africa/Maputo {STDOFF '2:10:20' not on 15-minute boundary}
# Africa/Monrovia {
#   STDOFF '-0:43:08' not on 15-minute boundary,
#   STDOFF '-0:44:30' not on 15-minute boundary,
# }
# Africa/Nairobi {STDOFF '2:27:16' not on 15-minute boundary}
# Africa/Ndjamena {STDOFF '1:00:12' not on 15-minute boundary}
# Africa/Sao_Tome {STDOFF '-0:36:45' not on 15-minute boundary}
# Africa/Tripoli {
...
# }
# America/Anchorage {
#   STDOFF '-9:59:36' not on 15-minute boundary,
#   US {Added anchor rule at year 0}
# }
# America/Araguaina {
...
#   Mexico {Added anchor rule at year 0}
# }
# America/Caracas {STDOFF '-4:27:40' not on 15-minute boundary}
# America/Cayenne {STDOFF '-3:29:20' not on 15-minute boundary}
# America/Chicago {
...
# }
# America/Cuiaba {
#   STDOFF '-3:44:20' not on 15-minute boundary,
#   Brazil {Added anchor rule at year 0}
# }
# America/Danmarkshavn {
#   STDOFF '-1:14:40' not on 15-minute boundary,
#   EU {Added anchor rule at year 0}
# }
# America/Dawson {
...
# }
# America/Glace_Bay {
#   STDOFF '-3:59:48' not on 15-minute boundary,
#   Canada {Added anchor rule at year 0}
...
# }
# America/Guyana {STDOFF '-3:52:39' not on 15-minute boundary}
# America/Halifax {
#   STDOFF '-4:14:24' not on 15-minute boundary,
#   Canada {Added anchor rule at year 0}
#   Halifax {Added anchor rule at year 0}
# }
# America/Havana {
#   STDOFF '-5:29:36' not on 15-minute boundary,
...
#   US {Added anchor rule at year 0}
# }
# America/La_Paz {STDOFF '-4:32:36' not on 15-minute boundary}
# America/Lima {
...
#   Brazil {Added anchor rule at year 0}
# }
# America/Martinique {STDOFF '-4:04:20' not on 15-minute boundary}
# America/Matamoros {
#   Mexico {Added anchor rule at year 0}
#   US {Added anchor rule at year 0}
# }
...
# }
# America/Miquelon {
#   STDOFF '-3:44:40' not on 15-minute boundary,
#   Canada {Added anchor rule at year 0}
# }
# America/Moncton {
#   Canada {Added anchor rule at year 0}
...
# }
# America/Montevideo {
#   STDOFF '-3:44:51' not on 15-minute boundary,
#   Uruguay {
#     Added anchor rule at year 0,
#     SAVE (delta_offset) '0:30' different from 1:00,
...
#   US {Added anchor rule at year 0}
# }
# America/Panama {STDOFF '-5:19:36' not on 15-minute boundary}
# America/Paramaribo {
...
#   RussiaAsia {Added anchor rule at year 0}
# }
# Asia/Bangkok {STDOFF '6:42:04' not on 15-minute boundary}
# Asia/Barnaul {
...
# }
# Asia/Dili {STDOFF '8:22:20' not on 15-minute boundary}
# Asia/Dubai {STDOFF '3:41:12' not on 15-minute boundary}
# Asia/Dushanbe {
#   STDOFF '4:35:12' not on 15-minute boundary,
#   RussiaAsia {Added anchor rule at year 0}
# }
# Asia/Famagusta {
#   STDOFF '2:15:48' not on 15-minute boundary,
...
#   }
# }
# Asia/Ho_Chi_Minh {STDOFF '7:06:30' not on 15-minute boundary}
# Asia/Hong_Kong {
#   RULES delta offset '0:30' different from 1:00,
...
# }
# Asia/Jayapura {STDOFF '9:22:48' not on 15-minute boundary}
# Asia/Jerusalem {
...
# }
# Asia/Kathmandu {STDOFF '5:41:16' not on 15-minute boundary}
# Asia/Khandyga {
...
#   }
# }
# Asia/Kolkata {STDOFF '5:21:10' not on 15-minute boundary}
# Asia/Krasnoyarsk {
...
# }
# Asia/Kuching {
#   SAVE (0:20) in Rule NBorneo not at :00 or :30 mark,
...
#   }
# }
# Asia/Makassar {STDOFF '7:57:36' not on 15-minute boundary}
# Asia/Manila {
...
#   RussiaAsia {Added anchor rule at year 0}
# }
# Asia/Pontianak {STDOFF '7:17:20' not on 15-minute boundary}
# Asia/Pyongyang {STDOFF '8:23:00' not on 15-minute boundary}
# Asia/Qatar {STDOFF '3:26:08' not on 15-minute boundary}
# Asia/Qostanay {
...
#   RussiaAsia {Added anchor rule at year 0}
# }
# Asia/Riyadh {STDOFF '3:06:52' not on 15-minute boundary}
# Asia/Sakhalin {
#   STDOFF '9:30:48' not on 15-minute boundary,
#   Russia {
#     Added anchor rule at year 0,
#     LETTER '+05' not single character,
#     LETTER 'MDST' not single character,
...
# }
# Asia/Thimphu {STDOFF '5:58:36' not on 15-minute boundary}
# Asia/Tokyo {
...
#   Mongol {Added anchor rule at year 0}
# }
# Asia/Urumqi {STDOFF '5:50:20' not on 15-minute boundary}
# Asia/Ust-Nera {
...
#   }
# }
# Asia/Yangon {STDOFF '6:24:47' not on 15-minute boundary}
# Asia/Yekaterinburg {
#   STDOFF '3:45:05' not on 15-minute boundary,
...
#   EU {Added anchor rule at year 0}
# }
# Atlantic/Cape_Verde {STDOFF '-1:34:04' not on 15-minute boundary}
# Atlantic/Faroe {
...
# }
# Europe/Madrid {
#   STDOFF '-0:14:44' not on 15-minute boundary,
#   EU {Added anchor rule at year 0}
#   Spain {
#     Added anchor rule at year 0,
#     SAVE (delta_offset) '2:00' different from 1:00,
...
# }
# Europe/Moscow {
#   STDOFF '2:30:17' not on 15-minute boundary,
...
# }
# Indian/Chagos {STDOFF '4:49:40' not on 15-minute boundary}
# Indian/Maldives {STDOFF '4:54:00' not on 15-minute boundary}
# Indian/Mauritius {
...
# }
# Pacific/Fakaofo {STDOFF '-11:24:56' not on 15-minute boundary}
# Pacific/Fiji {
...
#   Ecuador {Added anchor rule at year 0}
# }
# Pacific/Gambier {STDOFF '-8:59:48' not on 15-minute boundary}
# Pacific/Guadalcanal {STDOFF '10:39:48' not on 15-minute boundary}
# Pacific/Guam {
...
# }
# Pacific/Kiritimati {
#   STDOFF '-10:29:20' not on 15-minute boundary,
#   STDOFF '-10:40' not on 15-minute boundary,
# }
# Pacific/Kosrae {STDOFF '10:51:56' not on 15-minute boundary}
# Pacific/Kwajalein {STDOFF '11:09:20' not on 15-minute boundary}
# Pacific/Marquesas {STDOFF '-9:18:00' not on 15-minute boundary}
# Pacific/Nauru {STDOFF '11:07:40' not on 15-minute boundary}
# Pacific/Niue {
...
# }
# Pacific/Pago_Pago {STDOFF '-11:22:48' not on 15-minute boundary}
# Pacific/Palau {STDOFF '8:57:56' not on 15-minute boundary}
# Pacific/Pitcairn {STDOFF '-8:40:20' not on 15-minute boundary}
# Pacific/Rarotonga {
...
#   }
# }
# Pacific/Tahiti {STDOFF '-9:58:16' not on 15-minute boundary}
# Pacific/Tarawa {STDOFF '11:32:04' not on 15-minute boundary}
# Pacific/Tongatapu {
